...
func (tCertPool *tCertPoolMultithreadingImpl) GtoGetNextTCert(methodName string) (tCert tCert, err error) {
	// TODO: change error here
	return nil, errors.New("Not supported in multithreaded pool [SYDNEY]!")
}
