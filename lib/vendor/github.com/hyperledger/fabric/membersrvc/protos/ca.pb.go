...
type GTOTCertCreateSetReq struct {
	Ts     *google_protobuf.Timestamp `protobuf:"bytes,1,opt,name=ts" json:"ts,omitempty"`
	Tcerts *TCertCreateSetReq         `protobuf:"bytes,2,opt,name=tcerts" json:"tcerts,omitempty"`
	PubKey *PublicKey                 `protobuf:"bytes,3,opt,name=pubKey" json:"pubKey,omitempty"`
}

func (m *GTOTCertCreateSetReq) Reset()         { *m = GTOTCertCreateSetReq{} }
func (m *GTOTCertCreateSetReq) String() string { return proto.CompactTextString(m) }
func (*GTOTCertCreateSetReq) ProtoMessage()    {}

func (m *GTOTCertCreateSetReq) GetTs() *google_protobuf.Timestamp {
	if m != nil {
		return m.Ts
	}
	return nil
...
func (m *GTOTCertCreateSetReq) GetTcerts() *TCertCreateSetReq {
	if m != nil {
		return m.Tcerts
	}
	return nil
...
func (m *GTOTCertCreateSetReq) GetPubKey() *PublicKey {
	if m != nil {
		return m.PubKey
	}
	return nil
...
type TCAPClient interface {
	...
	GTOCreateCertificateSet(ctx context.Context, in *GTOTCertCreateSetReq, opts ...grpc.CallOption) (*TCertCreateSetResp, error)
}
...
func (c *tCAPClient) GTOCreateCertificateSet(ctx context.Context, in *GTOTCertCreateSetReq, opts ...grpc.CallOption) (*TCertCreateSetResp, error) {
	out := new(TCertCreateSetResp)
	err := grpc.Invoke(ctx, "/protos.TCAP/GTOCreateCertificateSet", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TCAPServer interface {
	...
	GTOCreateCertificateSet(context.Context, *GTOTCertCreateSetReq) (*TCertCreateSetResp, error)
}
...
func _TCAP_GTOCreateCertificateSet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(GTOTCertCreateSetReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(TCAPServer).GTOCreateCertificateSet(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _TCAP_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GTOCreateCertificateSet",
			Handler:    _TCAP_GTOCreateCertificateSet_Handler,
		},
	},
	Streams: []grpc.StreamDesc{},
}
