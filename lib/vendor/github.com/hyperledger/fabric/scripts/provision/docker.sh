...
echo ENV akp 'Aung_Khaing_Phyo'
echo ENV http_proxy 'http://proxy-sg-singapore.gemalto.com:8080'
echo ENV https_proxy 'https://proxy-sg-singapore.gemalto.com:8080'
echo ENV no_proxy '172.17.0.1,172.17.0.2,172.17.0.3,172.17.0.4,172.17.0.5,172.17.0.6,172.17.0.7,172.17.0.8,172.17.0.9,172.17.0.10'`
